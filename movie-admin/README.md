...
To build the final jar and optimize the MovieAdmin application for production, run:
...
Then navigate to [http://localhost:8071](http://localhost:8071) in your browser.
