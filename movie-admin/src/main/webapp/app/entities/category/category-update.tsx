  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="movieAdminApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="movieAdminApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('movieAdminApp.category.name')}
                id="category-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('movieAdminApp.category.description')}
              ...
              />
              <ValidatedField
                label={translate('movieAdminApp.category.isActive')}
              ...
              />
              <ValidatedField
                label={translate('movieAdminApp.category.createdDate')}
