...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './episode.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EPISODE_LIST actions', async () => {
    ...
    it('dispatches FETCH_EPISODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EPISODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EPISODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EPISODE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EPISODE actions', async () => {
      const expectedActions = [
        {
