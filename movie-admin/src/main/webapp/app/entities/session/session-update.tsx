...
export const SessionUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="movieAdminApp.session.home.createOrEditLabel" data-cy="SessionCreateUpdateHeading">
            <Translate contentKey="movieAdminApp.session.home.createOrEditLabel">Create or edit a Session</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('movieAdminApp.session.name')}
                id="session-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('movieAdminApp.session.description')}
              ...
              />
              <ValidatedField
                label={translate('movieAdminApp.session.createdDate')}
                id="session-createdDate"
                name="createdDate"
                data-cy="createdDate"
                type="date"
                validate={{
