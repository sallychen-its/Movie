...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './trailer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAILER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRAILER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRAILER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRAILER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRAILER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRAILER actions', async () => {
      const expectedActions = [
        {
