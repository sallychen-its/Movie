...
import com.movie_admin.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    void putNewCategory() throws Exception {
        ...
        updatedCategory.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).isActive(UPDATED_IS_ACTIVE).createdDate(UPDATED_CREATED_DATE);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.name(UPDATED_NAME).createdDate(UPDATED_CREATED_DATE);
